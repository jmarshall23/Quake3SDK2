...
static void UI_RemoveBotsMenu_Init( void ) {
	...
	removeBotsMenuInfo.bmdelete.generic.type		= MTYPE_BITMAP;
	removeBotsMenuInfo.bmdelete.generic.name		= ART_DELETE0;
	removeBotsMenuInfo.bmdelete.generic.flags		= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
	removeBotsMenuInfo.bmdelete.generic.id		= ID_DELETE;
	removeBotsMenuInfo.bmdelete.generic.callback	= UI_RemoveBotsMenu_DeleteEvent;
	removeBotsMenuInfo.bmdelete.generic.x			= 320+128-128;
	removeBotsMenuInfo.bmdelete.generic.y			= 256+128-64;
	removeBotsMenuInfo.bmdelete.width  			= 128;
	removeBotsMenuInfo.bmdelete.height  			= 64;
	removeBotsMenuInfo.bmdelete.focuspic			= ART_DELETE1;
	...
	Menu_AddItem( &removeBotsMenuInfo.menu, &removeBotsMenuInfo.bmdelete );
