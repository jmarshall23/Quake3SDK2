...
//
	...
	if (cinTable[currentHandle].inMemory && (cinTable[currentHandle].status != FMV_EOF)) { cinTable[currentHandle].inMemory = (qboolean)!cinTable[currentHandle].inMemory; framedata += 8; goto redump; }
//
