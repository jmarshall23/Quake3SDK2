...
void SV_InitGameProgs( void ) {
	...
	gameExports.Cvar_Register = (void(__cdecl*)(void*, const char*, const char*, int))Cvar_Register;
	gameExports.Cvar_Update = (void(__cdecl*)(void*))Cvar_Update;
	...
	gameExports.LocateGameData = (void(__cdecl*)(void*, int, int, void*, int))SV_LocateGameData;
	...
	gameExports.SetBrushModel = (void(__cdecl*)(void*, const char*))SV_SetBrushModel;
	gameExports.Trace = SV_Trace;
	gameExports.PointContents = (int(__cdecl*)(const void*, int))SV_PointContents;
	gameExports.inPVS = (qboolean(__cdecl*)(const void*, const void*))SV_inPVS;
	gameExports.inPVSIgnorePortals = (qboolean(__cdecl*)(const void*, const void*))SV_inPVSIgnorePortals;
	gameExports.AdjustAreaPortalState = SV_AdjustAreaPortalState;
	gameExports.AreasConnected = CM_AreasConnected;
	gameExports.LinkEntity = (void(__cdecl*)(void*))SV_LinkEntity;
	gameExports.UnlinkEntity = (void(__cdecl*)(void*))SV_UnlinkEntity;
	gameExports.EntitiesInBox = (int(__cdecl*)(const void*, const void*, int*, int))SV_AreaEntities;
	gameExports.EntityContact = SV_EntityContact;
	gameExports.GetUsercmd = (void(__cdecl*)(int, void*))SV_GetUsercmd;
	gameExports.GetEntityToken = SV_GetEntityToken;
	gameExports.RealTime = (int(__cdecl*)(void*))Com_RealTime;
